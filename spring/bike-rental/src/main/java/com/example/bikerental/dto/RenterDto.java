...
public class RenterDto {
    ...
    private List<BikeDto> bike = new ArrayList<>();
    ...
    public RenterDto(Long id) {
        this.id = id;
    }

    public RenterDto(String email, String password, String mobileNumber, String userName, String gender,
